...
function getProjectByTitle(title) {
  return data.projects.find((project) => project.title.toLowerCase() === title.toLowerCase());
}
    ...
    <section className="section pt-16 sm:p-24 lg:p-48 min-h-screen">
      <div className='document__data'>
        ...
        <div className='flex flex-row items-center gap-4'>
          ...
          {
            project.demo &&
            <Link to={`/projects/${project.title.toLowerCase()}/demo`} target='_blank' rel='noreferrer'>
